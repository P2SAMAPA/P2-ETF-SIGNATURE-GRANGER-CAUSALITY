...
OUTPUT_REPO = "P2SAMAPA/p2-etf-signature-granger-causality-results"
...
# Signature Granger parameters
SIG_DEPTH = 4                # signature truncation depth
MAX_LAG = 5                  # maximum lag for Granger test
TOP_N = 3
